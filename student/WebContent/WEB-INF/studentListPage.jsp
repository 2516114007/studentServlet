...
<head>
	...
	<style>
		*{padding: 0; margin: 0;}
		...
		.pageBtn span{margin-right: 20px;}
	</style>
</head>
<body>
	<table border="1">
		...
		<tbody>
			...
			<tr>
				<td colspan="8" class="pageBtn">
					<span>第${pageBean.currentPage }/${pageBean.totalPage }页</span>
					<span>每页显示${pageBean.pageSize }条记录</span>
					<span>共${pageBean.totalSize }条记录</span>
					<a href="/student/pageStudentListServlet?currentPage=2">2</a>
				</td>
			</tr>
		</tbody>
	</table>
